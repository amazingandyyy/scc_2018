...
class SignupVerification extends Component {
    ...
    handleFormSubmit(data) {
        ...
        const avatarchoices = [
            'https://s3-us-west-1.amazonaws.com/scc-2018/users/mascot/mascot-m.jpg',
            'https://s3-us-west-1.amazonaws.com/scc-2018/users/mascot/mascot-w.jpg'
        ]
        data.email = address;
            ...
            return <div>
                ...
                <form onSubmit={handleSubmit(this.handleFormSubmit.bind(this))} onChange={signupEmailReset}>
                    ...
                    <div style={{'padding': '15px 0px'}}>
                        <button type='submit' className='btn btn-lg btn-primary btn-block'>Join Now!</button>
                    </div>
